...
class DescendingPage extends StatefulWidget {
  const DescendingPage({Key? key}) : super(key: key);

  @override
  State<DescendingPage> createState() => _DescendingPageState();
}

class _DescendingPageState extends State<DescendingPage> {

  final Stream<QuerySnapshot> ageDescendingStream =
  FirebaseFirestore.instance.collection('pet').orderBy('年齢',descending: true ).snapshots();
